...
/**
 * Created by Muguntan on 12/9/2017.
 */
...
public class ColorBlobDetector {
    ...
    public void setHsvColor(Scalar hsvColor){
        ...
        for(int i = 0; i<maxH-minH ; i++){
            byte[] tmp = {(byte) (minH + i), (byte) 255, (byte) 255};
            spectrumHsv.put(0, i, tmp);
        }
    ...
    public void process(Mat rgbaImage){
        Imgproc.pyrDown(rgbaImage,myPyrDownMat);
        Imgproc.pyrDown(myPyrDownMat,myPyrDownMat);

        Imgproc.cvtColor(myPyrDownMat,mHsvMat, Imgproc.COLOR_RGB2HSV_FULL);
